(() => {
  ...
  function ensureDialog() {
    ...
    dialog.innerHTML = `<button class="membership-dialog-close" type="button" aria-label="Close">×</button><div class="membership-dialog-inner"><div class="eyebrow">LUNE CIRCLE</div><h2>For the version of you that does not happen by accident.</h2><p>Circle is a closer relationship with Lune: your direction, your time, and the work you return to.</p><div class="membership-plan"><small>MONTHLY MEMBERSHIP · OPENING SOON</small><strong>10% member rate on selected services.</strong></div><div class="membership-benefits"><div class="membership-benefit"><b>Priority access</b>Earlier access to selected appointment windows.</div><div class="membership-benefit"><b>Your direction, kept close</b>A personal edit shaped by what you save.</div><div class="membership-benefit"><b>First to the edit</b>New Lune directions before they become the feed.</div></div><div class="membership-dialog-actions"><a class="button" href="account.html">Create your Lune <span class="arrow">→</span></a><button class="quiet-action" type="button" data-circle-dismiss>Not now</button></div></div>`;
